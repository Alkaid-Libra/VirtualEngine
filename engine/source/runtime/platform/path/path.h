...
namespace VE
{
    ...
    public:
        ...
        static const std::vector<std::string> getPathSements(const std::filesystem::path& file_path);

        const std::tuple<std::string, std::string, std::string> getFileExtensions(const std::filesystem::path& file_path) const;
