    ...
    public:
        ...
        */
        ...
        static Matrix4x4 rotationMatrix(Vector3 normal)
        {
            ...
            result.setMatrix3x3(Matrix3x3(left, up, normal)); // local to world

            return result.transpose(); // world to local
        }
        ...
        */
        ...
        Transform is performed in the order 1.scale, 2.rotate, 3.translation, i.e. translation is independent
        ...
        */
        ...
        performing -1.translation, -2.rotate, 3.1/scale in that order.
        */
