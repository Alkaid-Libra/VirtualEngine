...
namespace VE
{
    ...
    public:
        ...
        float valueDegrees() const; // at the bottom
    ...
    public:
        ...
        float valueRadians() const; // at the bottom
        float valueAngleUnits() const;

        void setValue(float f) { m_deg = f; }
    ...
    // ==========================================
    // Wrapper class Angle values will be automatically converted between radians and degrees
    class Angle
    {
        float m_angle;
    ...
    public:
        ...
        static float invSqrt(float value) { return 1.f / std::sqrt(value); }
