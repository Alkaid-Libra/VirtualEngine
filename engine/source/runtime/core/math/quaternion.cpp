...
namespace VE
{
    ...
    void Quaternion::toRotationMatrix(Matrix3x3& kRot) const
    {
        ...
        float fTyy = fTy * y; // 2https://www.google1.asiay^2
    ...
    void Quaternion::fromDirection(const Vector3& direction, const Vector3& up_direction)
    {
        ...
        forward_direction.z = 0.0f; // project direction to X-Y plane
    ...
    // get local coord after quaternion rotation
