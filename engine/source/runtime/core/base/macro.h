...
#define VIRTUAL_INVALID_GOBJECT_ID std::numeric_limits<size_t>::max()
...
#define VirtualSleep(_ms) std::this_thread::sleep_for(std::chrono::milliseconds(_ms));

#define VirtualNameOf(name) #name
