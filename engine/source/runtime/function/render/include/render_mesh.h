...
namespace VE
{
    ...
    struct Mesh_PosNormalTangentTex_Vertex
    {
    ...
    public:
        ...
        VertexBufferHandle m_vertexBuffer = VIRTUAL_INVALID_HANDLE;
        IndexBufferHandle m_indexBuffer = VIRTUAL_INVALID_HANDLE;
        // vertex blending
        bool m_enable_vertex_blending = false;
        SkeletonBindingBufferHandle skeleton_binding_handle = VIRTUAL_INVALID_HANDLE;
