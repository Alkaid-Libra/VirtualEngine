...
namespace VE
{
    void metaExample()
    {
        ...
        auto test1_json_in = VSerializer::write(test1_in);
        ...
        auto&& Test1_json = VJson::parse(test1_context, err);
        VSerializer::read(Test1_json, test1_out);
        LOG_INFO(test1_context);

        auto        Test2_json_in = VSerializer::write(test2_in);
        ...
        Test2  test2_out;
        auto&& test2_json = VJson::parse(test2_context, err);
        VSerializer::read(test2_json, test2_out);
